...
export class PengajuanPeminatanService {
  private url =
    'https://api.simitafapetub.com/peminatanmhs';
  ...
  uploadFileSuratRekomendasi(formData: Partial<PeminatanMahasiswa>) {
    ...
    return this.http.post(`https://api.simitafapetub.com/datapeminatanmahasiswa/upload`, fd);
  ...
  uploadFileKhs(formData: Partial<PeminatanMahasiswa>) {
    ...
    return this.http.post(`https://api.simitafapetub.com/datapeminatanmahasiswa/uploadKhs`, fd);
